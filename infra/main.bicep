metadata description = 'Provisions resources for a web application that uses Azure SDK for .NET to connect to Azure Cosmos DB for Table.'
...
var tags = {
  ...
  repo: 'https://github.com/azure-samples/cosmos-db-table-java-quickstart'
}
